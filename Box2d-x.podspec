#
#  Be sure to run `pod spec lint Box2d-x.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.name         = "Box2d-x"
  s.version      = "0.1"
  s.summary      = "Only a Box2d copy on github"

  s.description  = <<-DESC
                   A longer description of Box2d-x in Markdown format.
  ...
  s.homepage     = "https://github.com/xudeheng/box2d-x"
  ...
  s.source       = { :git => "https://github.com/xudeheng/box2d-x.git", :tag => "0.1" }
  ...
  s.xcconfig = { "HEADER_SEARCH_PATHS" => "$(PODS_ROOT)/Box2d-x/src/" }
